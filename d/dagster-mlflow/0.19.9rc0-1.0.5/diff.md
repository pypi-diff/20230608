# Comparing `tmp/dagster-mlflow-0.19.9rc0.tar.gz` & `tmp/dagster-mlflow-1.0.5.tar.gz`
...
## Comparing `dagster-mlflow-0.19.9rc0.tar` & `dagster-mlflow-1.0.5.tar`
...
### Comparing `dagster-mlflow-0.19.9rc0/LICENSE` & `dagster-mlflow-1.0.5/LICENSE`
...
### Comparing `dagster-mlflow-0.19.9rc0/dagster_mlflow/hooks.py` & `dagster-mlflow-1.0.5/dagster_mlflow/hooks.py`
...
### Comparing `dagster-mlflow-0.19.9rc0/dagster_mlflow/resources.py` & `dagster-mlflow-1.0.5/dagster_mlflow/resources.py`
...
### Comparing `dagster-mlflow-0.19.9rc0/setup.py` & `dagster-mlflow-1.0.5/setup.py`
