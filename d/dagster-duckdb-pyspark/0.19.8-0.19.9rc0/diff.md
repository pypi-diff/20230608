# Comparing `tmp/dagster-duckdb-pyspark-0.19.8.tar.gz` & `tmp/dagster-duckdb-pyspark-0.19.9rc0.tar.gz`
...
## Comparing `dagster-duckdb-pyspark-0.19.8.tar` & `dagster-duckdb-pyspark-0.19.9rc0.tar`
...
### Comparing `dagster-duckdb-pyspark-0.19.8/LICENSE` & `dagster-duckdb-pyspark-0.19.9rc0/LICENSE`

 * *Files identical despite different names*

### Comparing `dagster-duckdb-pyspark-0.19.8/PKG-INFO` & `dagster-duckdb-pyspark-0.19.9rc0/PKG-INFO`
...
### Comparing `dagster-duckdb-pyspark-0.19.8/dagster_duckdb_pyspark/duckdb_pyspark_type_handler.py` & `dagster-duckdb-pyspark-0.19.9rc0/dagster_duckdb_pyspark/duckdb_pyspark_type_handler.py`

 * *Files identical despite different names*

### Comparing `dagster-duckdb-pyspark-0.19.8/dagster_duckdb_pyspark.egg-info/PKG-INFO` & `dagster-duckdb-pyspark-0.19.9rc0/dagster_duckdb_pyspark.egg-info/PKG-INFO`
...
### Comparing `dagster-duckdb-pyspark-0.19.8/setup.py` & `dagster-duckdb-pyspark-0.19.9rc0/setup.py`
