# Comparing `tmp/datayoga-1.85.0.tar.gz` & `tmp/datayoga-1.9.0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "datayoga-1.85.0.tar", max compression
+gzip compressed data, was "datayoga-1.9.0.tar", max compression
```

## Comparing `datayoga-1.85.0.tar` & `datayoga-1.9.0.tar`

### file list

```diff
@@ -1,6 +1,7 @@
--rw-r--r--   0        0        0      633 2023-06-08 09:45:55.817667 datayoga-1.85.0/README.md
--rw-r--r--   0        0        0     1284 2023-06-08 09:46:13.937566 datayoga-1.85.0/pyproject.toml
--rw-r--r--   0        0        0        0 2023-06-08 09:45:55.817667 datayoga-1.85.0/src/datayoga/__init__.py
--rw-r--r--   0        0        0     5623 2023-06-08 09:45:55.817667 datayoga-1.85.0/src/datayoga/__main__.py
--rw-r--r--   0        0        0     3280 2023-06-08 09:45:55.817667 datayoga-1.85.0/src/datayoga/cli_helpers.py
--rw-r--r--   0        0        0     2023 1970-01-01 00:00:00.000000 datayoga-1.85.0/PKG-INFO
...
### Comparing `datayoga-1.85.0/pyproject.toml` & `datayoga-1.9.0/pyproject.toml`
...
### Comparing `datayoga-1.85.0/src/datayoga/__main__.py` & `datayoga-1.9.0/src/datayoga/__main__.py`
...
### Comparing `datayoga-1.85.0/PKG-INFO` & `datayoga-1.9.0/PKG-INFO`
