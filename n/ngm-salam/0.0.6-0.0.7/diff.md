# Comparing `tmp/ngm_salam-0.0.6.tar.gz` & `tmp/ngm_salam-0.0.7.tar.gz`
...
## Comparing `ngm_salam-0.0.6.tar` & `ngm_salam-0.0.7.tar`
...
### Comparing `ngm_salam-0.0.6/ngm_salam/sysparams.py` & `ngm_salam-0.0.7/ngm_salam/sysparams.py`
