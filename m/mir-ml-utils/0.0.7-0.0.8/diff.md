# Comparing `tmp/mir_ml_utils-0.0.7.tar.gz` & `tmp/mir_ml_utils-0.0.8.tar.gz`
...
### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/mir_vision/references/detection/transforms.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/mir_vision/references/detection/transforms.py`
...
### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/mir_vision/references/segmentation/coco_utils.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/mir_vision/references/segmentation/coco_utils.py`
...
### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/models/models_enum.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/models/models_enum.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/models/resnet_model_predictor_wrapper.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/models/resnet_model_predictor_wrapper.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/pytorch_util_modules/pytorch_hooks.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/pytorch_util_modules/pytorch_hooks.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/testers/test_wrapper.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/testers/test_wrapper.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/testers/two_class_model_tester_wrapper.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/testers/two_class_model_tester_wrapper.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/trainers/pytorch_trainer.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/trainers/pytorch_trainer.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/trainers/trainer_info.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/trainers/trainer_info.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/trainers/trainer_wrapper.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/trainers/trainer_wrapper.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/trainers/trainer_wrapper_pimpl.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/trainers/trainer_wrapper_pimpl.py`
...
### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/utils/apps_utils.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/utils/apps_utils.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/utils/array_utils.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/utils/array_utils.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/utils/exceptions.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/utils/exceptions.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/utils/file_utils.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/utils/file_utils.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/utils/function_wrappers.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/utils/function_wrappers.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/src/mir_ml_utils/utils/math_ops.py` & `mir_ml_utils-0.0.8/src/mir_ml_utils/utils/math_ops.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/testing_data/corrosion_4.png` & `mir_ml_utils-0.0.8/testing_data/corrosion_4.png`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/testing_data/hull001_label.jpg` & `mir_ml_utils-0.0.8/testing_data/hull001_label.jpg`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/testing_data/prototypical_net_test_data/best_model.pth` & `mir_ml_utils-0.0.8/testing_data/prototypical_net_test_data/best_model.pth`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/testing_data/prototypical_net_test_data/train_prototypes.pth` & `mir_ml_utils-0.0.8/testing_data/prototypical_net_test_data/train_prototypes.pth`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/testing_data/prototypical_net_test_data/inference/corrosion_1.png` & `mir_ml_utils-0.0.8/testing_data/prototypical_net_test_data/inference/corrosion_1.png`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/testing_data/prototypical_net_test_data/inference/corrosion_2.png` & `mir_ml_utils-0.0.8/testing_data/prototypical_net_test_data/inference/corrosion_2.png`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/testing_data/prototypical_net_test_data/inference/corrosion_3.png` & `mir_ml_utils-0.0.8/testing_data/prototypical_net_test_data/inference/corrosion_3.png`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/testing_data/prototypical_net_test_data/inference/corrosion_4.png` & `mir_ml_utils-0.0.8/testing_data/prototypical_net_test_data/inference/corrosion_4.png`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/tests/test_images_dataset.py` & `mir_ml_utils-0.0.8/tests/test_images_dataset.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/tests/test_img_pipeline.py` & `mir_ml_utils-0.0.8/tests/test_img_pipeline.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/tests/test_img_utils.py` & `mir_ml_utils-0.0.8/tests/test_img_utils.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/tests/test_prototypical_loss.py` & `mir_ml_utils-0.0.8/tests/test_prototypical_loss.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/tests/test_pytorch_trainer.py` & `mir_ml_utils-0.0.8/tests/test_pytorch_trainer.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/tests/test_suite.py` & `mir_ml_utils-0.0.8/tests/test_suite.py`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/trainer_wrapper_config_template/config.json` & `mir_ml_utils-0.0.8/trainer_wrapper_config_template/config.json`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/.gitignore` & `mir_ml_utils-0.0.8/.gitignore`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/LICENSE` & `mir_ml_utils-0.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/README.md` & `mir_ml_utils-0.0.8/README.md`

 * *Files identical despite different names*

### Comparing `mir_ml_utils-0.0.7/pyproject.toml` & `mir_ml_utils-0.0.8/pyproject.toml`
...
### Comparing `mir_ml_utils-0.0.7/PKG-INFO` & `mir_ml_utils-0.0.8/PKG-INFO`
