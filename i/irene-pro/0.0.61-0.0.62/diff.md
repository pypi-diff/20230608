# Comparing `tmp/irene_pro-0.0.61.tar.gz` & `tmp/irene_pro-0.0.62.tar.gz`
...
## Comparing `irene_pro-0.0.61.tar` & `irene_pro-0.0.62.tar`
...
### Comparing `irene_pro-0.0.61/PKG-INFO` & `irene_pro-0.0.62/PKG-INFO`
...
### Comparing `irene_pro-0.0.61/README.md` & `irene_pro-0.0.62/README.md`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.61/irene_pro/logic.py` & `irene_pro-0.0.62/irene_pro/logic.py`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.61/irene_pro/widgets.py` & `irene_pro-0.0.62/irene_pro/widgets.py`
...
### Comparing `irene_pro-0.0.61/irene_pro.egg-info/PKG-INFO` & `irene_pro-0.0.62/irene_pro.egg-info/PKG-INFO`
...
### Comparing `irene_pro-0.0.61/setup.py` & `irene_pro-0.0.62/setup.py`
