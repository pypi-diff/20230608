# Comparing `tmp/irene_pro-0.0.51.tar.gz` & `tmp/irene_pro-0.0.52.tar.gz`
...
## Comparing `irene_pro-0.0.51.tar` & `irene_pro-0.0.52.tar`
...
### Comparing `irene_pro-0.0.51/PKG-INFO` & `irene_pro-0.0.52/PKG-INFO`
...
### Comparing `irene_pro-0.0.51/README.md` & `irene_pro-0.0.52/README.md`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.51/irene_pro/logic.py` & `irene_pro-0.0.52/irene_pro/logic.py`

 * *Files identical despite different names*

### Comparing `irene_pro-0.0.51/irene_pro/widgets.py` & `irene_pro-0.0.52/irene_pro/widgets.py`
...
### Comparing `irene_pro-0.0.51/irene_pro.egg-info/PKG-INFO` & `irene_pro-0.0.52/irene_pro.egg-info/PKG-INFO`
...
### Comparing `irene_pro-0.0.51/setup.py` & `irene_pro-0.0.52/setup.py`
