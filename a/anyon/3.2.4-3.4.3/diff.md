# Comparing `tmp/anyon-3.2.4-cp311-cp311-win_amd64.whl.zip` & `tmp/anyon-3.4.3-cp311-cp311-win_amd64.whl.zip`
...
## Comparing `anyon-3.2.4.dist-info/LICENSE` & `anyon-3.4.3.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `anyon-3.2.4.dist-info/METADATA` & `anyon-3.4.3.dist-info/METADATA`
