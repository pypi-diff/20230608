# Comparing `tmp/spark-nlp-4.4.3.tar.gz` & `tmp/spark-nlp-4.4.4.tar.gz`
...
### Comparing `spark-nlp-4.4.3/README.md` & `spark-nlp-4.4.4/README.md`
...
### Comparing `spark-nlp-4.4.3/setup.py` & `spark-nlp-4.4.4/setup.py`
...
### Comparing `spark-nlp-4.4.3/spark_nlp.egg-info/PKG-INFO` & `spark-nlp-4.4.4/spark_nlp.egg-info/PKG-INFO`
...
### Comparing `spark-nlp-4.4.3/spark_nlp.egg-info/SOURCES.txt` & `spark-nlp-4.4.4/spark_nlp.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/__init__.py` & `spark-nlp-4.4.4/sparknlp/__init__.py`
...
### Comparing `spark-nlp-4.4.3/sparknlp/annotation.py` & `spark-nlp-4.4.4/sparknlp/annotation.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotation_audio.py` & `spark-nlp-4.4.4/sparknlp/annotation_audio.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotation_image.py` & `spark-nlp-4.4.4/sparknlp/annotation_image.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/audio/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/audio/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/audio/hubert_for_ctc.py` & `spark-nlp-4.4.4/sparknlp/annotator/audio/hubert_for_ctc.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/audio/wav2vec2_for_ctc.py` & `spark-nlp-4.4.4/sparknlp/annotator/audio/wav2vec2_for_ctc.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/chunk2_doc.py` & `spark-nlp-4.4.4/sparknlp/annotator/chunk2_doc.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/chunker.py` & `spark-nlp-4.4.4/sparknlp/annotator/chunker.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/albert_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/albert_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/albert_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/albert_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/albert_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/albert_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/bert_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/bert_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/bert_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/bert_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/bert_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/bert_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/bert_for_zero_shot_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/bert_for_zero_shot_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/camembert_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/camembert_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/camembert_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/camembert_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/camembert_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/camembert_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/classifier_dl.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/classifier_dl.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/deberta_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/deberta_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/deberta_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/deberta_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/deberta_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/deberta_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/distil_bert_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/distil_bert_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/distil_bert_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/distil_bert_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/distil_bert_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/distil_bert_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/distil_bert_for_zero_shot_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/distil_bert_for_zero_shot_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/longformer_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/longformer_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/longformer_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/longformer_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/longformer_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/longformer_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/multi_classifier_dl.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/multi_classifier_dl.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/roberta_bert_for_zero_shot_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/roberta_bert_for_zero_shot_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/roberta_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/roberta_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/roberta_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/roberta_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/roberta_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/roberta_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/sentiment_dl.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/sentiment_dl.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/tapas_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/tapas_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/xlm_roberta_for_question_answering.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/xlm_roberta_for_question_answering.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/xlm_roberta_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/xlm_roberta_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/xlm_roberta_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/xlm_roberta_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/xlnet_for_sequence_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/xlnet_for_sequence_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/classifier_dl/xlnet_for_token_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/classifier_dl/xlnet_for_token_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/coref/spanbert_coref.py` & `spark-nlp-4.4.4/sparknlp/annotator/coref/spanbert_coref.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/cv/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/cv/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/cv/convnext_for_image_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/cv/convnext_for_image_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/cv/swin_for_image_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/cv/swin_for_image_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/cv/vit_for_image_classification.py` & `spark-nlp-4.4.4/sparknlp/annotator/cv/vit_for_image_classification.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/date2_chunk.py` & `spark-nlp-4.4.4/sparknlp/annotator/date2_chunk.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/dependency/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/dependency/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/dependency/dependency_parser.py` & `spark-nlp-4.4.4/sparknlp/annotator/dependency/dependency_parser.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/dependency/typed_dependency_parser.py` & `spark-nlp-4.4.4/sparknlp/annotator/dependency/typed_dependency_parser.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/document_normalizer.py` & `spark-nlp-4.4.4/sparknlp/annotator/document_normalizer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/albert_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/albert_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/bert_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/bert_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/bert_sentence_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/bert_sentence_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/camembert_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/camembert_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/chunk_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/chunk_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/deberta_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/deberta_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/distil_bert_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/distil_bert_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/doc2vec.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/doc2vec.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/elmo_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/elmo_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/longformer_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/longformer_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/roberta_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/roberta_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/roberta_sentence_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/roberta_sentence_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/sentence_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/sentence_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/universal_sentence_encoder.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/universal_sentence_encoder.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/word2vec.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/word2vec.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/word_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/word_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/xlm_roberta_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/xlm_roberta_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/xlm_roberta_sentence_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/xlm_roberta_sentence_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/embeddings/xlnet_embeddings.py` & `spark-nlp-4.4.4/sparknlp/annotator/embeddings/xlnet_embeddings.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/er/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/er/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/er/entity_ruler.py` & `spark-nlp-4.4.4/sparknlp/annotator/er/entity_ruler.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/graph_extraction.py` & `spark-nlp-4.4.4/sparknlp/annotator/graph_extraction.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/keyword_extraction/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/keyword_extraction/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/keyword_extraction/yake_keyword_extraction.py` & `spark-nlp-4.4.4/sparknlp/annotator/keyword_extraction/yake_keyword_extraction.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ld_dl/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/ld_dl/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ld_dl/language_detector_dl.py` & `spark-nlp-4.4.4/sparknlp/annotator/ld_dl/language_detector_dl.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/lemmatizer.py` & `spark-nlp-4.4.4/sparknlp/annotator/lemmatizer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/matcher/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/matcher/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/matcher/big_text_matcher.py` & `spark-nlp-4.4.4/sparknlp/annotator/matcher/big_text_matcher.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/matcher/date_matcher.py` & `spark-nlp-4.4.4/sparknlp/annotator/matcher/date_matcher.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/matcher/multi_date_matcher.py` & `spark-nlp-4.4.4/sparknlp/annotator/matcher/multi_date_matcher.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/matcher/regex_matcher.py` & `spark-nlp-4.4.4/sparknlp/annotator/matcher/regex_matcher.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/matcher/text_matcher.py` & `spark-nlp-4.4.4/sparknlp/annotator/matcher/text_matcher.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/n_gram_generator.py` & `spark-nlp-4.4.4/sparknlp/annotator/n_gram_generator.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ner/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/ner/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ner/ner_approach.py` & `spark-nlp-4.4.4/sparknlp/annotator/ner/ner_approach.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ner/ner_converter.py` & `spark-nlp-4.4.4/sparknlp/annotator/ner/ner_converter.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ner/ner_crf.py` & `spark-nlp-4.4.4/sparknlp/annotator/ner/ner_crf.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ner/ner_dl.py` & `spark-nlp-4.4.4/sparknlp/annotator/ner/ner_dl.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ner/ner_overwriter.py` & `spark-nlp-4.4.4/sparknlp/annotator/ner/ner_overwriter.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ner/zero_shot_ner_model.py` & `spark-nlp-4.4.4/sparknlp/annotator/ner/zero_shot_ner_model.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/normalizer.py` & `spark-nlp-4.4.4/sparknlp/annotator/normalizer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/param/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/param/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/param/classifier_encoder.py` & `spark-nlp-4.4.4/sparknlp/annotator/param/classifier_encoder.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/param/evaluation_dl_params.py` & `spark-nlp-4.4.4/sparknlp/annotator/param/evaluation_dl_params.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/pos/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/pos/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/pos/perceptron.py` & `spark-nlp-4.4.4/sparknlp/annotator/pos/perceptron.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/sentence/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/sentence/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/sentence/sentence_detector.py` & `spark-nlp-4.4.4/sparknlp/annotator/sentence/sentence_detector.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/sentence/sentence_detector_dl.py` & `spark-nlp-4.4.4/sparknlp/annotator/sentence/sentence_detector_dl.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/sentiment/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/sentiment/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/sentiment/sentiment_detector.py` & `spark-nlp-4.4.4/sparknlp/annotator/sentiment/sentiment_detector.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/sentiment/vivekn_sentiment.py` & `spark-nlp-4.4.4/sparknlp/annotator/sentiment/vivekn_sentiment.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/seq2seq/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/seq2seq/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/seq2seq/bart_transformer.py` & `spark-nlp-4.4.4/sparknlp/annotator/seq2seq/bart_transformer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/seq2seq/gpt2_transformer.py` & `spark-nlp-4.4.4/sparknlp/annotator/seq2seq/gpt2_transformer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/seq2seq/marian_transformer.py` & `spark-nlp-4.4.4/sparknlp/annotator/seq2seq/marian_transformer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/seq2seq/t5_transformer.py` & `spark-nlp-4.4.4/sparknlp/annotator/seq2seq/t5_transformer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/spell_check/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/spell_check/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/spell_check/context_spell_checker.py` & `spark-nlp-4.4.4/sparknlp/annotator/spell_check/context_spell_checker.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/spell_check/norvig_sweeting.py` & `spark-nlp-4.4.4/sparknlp/annotator/spell_check/norvig_sweeting.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/spell_check/symmetric_delete.py` & `spark-nlp-4.4.4/sparknlp/annotator/spell_check/symmetric_delete.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/stemmer.py` & `spark-nlp-4.4.4/sparknlp/annotator/stemmer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/stop_words_cleaner.py` & `spark-nlp-4.4.4/sparknlp/annotator/stop_words_cleaner.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/tf_ner_dl_graph_builder.py` & `spark-nlp-4.4.4/sparknlp/annotator/tf_ner_dl_graph_builder.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/token/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/token/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/token/chunk_tokenizer.py` & `spark-nlp-4.4.4/sparknlp/annotator/token/chunk_tokenizer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/token/recursive_tokenizer.py` & `spark-nlp-4.4.4/sparknlp/annotator/token/recursive_tokenizer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/token/regex_tokenizer.py` & `spark-nlp-4.4.4/sparknlp/annotator/token/regex_tokenizer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/token/tokenizer.py` & `spark-nlp-4.4.4/sparknlp/annotator/token/tokenizer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ws/__init__.py` & `spark-nlp-4.4.4/sparknlp/annotator/ws/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/annotator/ws/word_segmenter.py` & `spark-nlp-4.4.4/sparknlp/annotator/ws/word_segmenter.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/__init__.py` & `spark-nlp-4.4.4/sparknlp/base/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/audio_assembler.py` & `spark-nlp-4.4.4/sparknlp/base/audio_assembler.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/doc2_chunk.py` & `spark-nlp-4.4.4/sparknlp/base/doc2_chunk.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/document_assembler.py` & `spark-nlp-4.4.4/sparknlp/base/document_assembler.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/embeddings_finisher.py` & `spark-nlp-4.4.4/sparknlp/base/embeddings_finisher.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/finisher.py` & `spark-nlp-4.4.4/sparknlp/base/finisher.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/graph_finisher.py` & `spark-nlp-4.4.4/sparknlp/base/graph_finisher.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/has_recursive_fit.py` & `spark-nlp-4.4.4/sparknlp/base/has_recursive_fit.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/has_recursive_transform.py` & `spark-nlp-4.4.4/sparknlp/base/has_recursive_transform.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/image_assembler.py` & `spark-nlp-4.4.4/sparknlp/base/image_assembler.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/light_pipeline.py` & `spark-nlp-4.4.4/sparknlp/base/light_pipeline.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/multi_document_assembler.py` & `spark-nlp-4.4.4/sparknlp/base/multi_document_assembler.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/recursive_pipeline.py` & `spark-nlp-4.4.4/sparknlp/base/recursive_pipeline.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/table_assembler.py` & `spark-nlp-4.4.4/sparknlp/base/table_assembler.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/token2_chunk.py` & `spark-nlp-4.4.4/sparknlp/base/token2_chunk.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/base/token_assembler.py` & `spark-nlp-4.4.4/sparknlp/base/token_assembler.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/__init__.py` & `spark-nlp-4.4.4/sparknlp/common/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/annotator_approach.py` & `spark-nlp-4.4.4/sparknlp/common/annotator_approach.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/annotator_model.py` & `spark-nlp-4.4.4/sparknlp/common/annotator_model.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/annotator_properties.py` & `spark-nlp-4.4.4/sparknlp/common/annotator_properties.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/annotator_type.py` & `spark-nlp-4.4.4/sparknlp/common/annotator_type.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/coverage_result.py` & `spark-nlp-4.4.4/sparknlp/common/coverage_result.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/match_strategy.py` & `spark-nlp-4.4.4/sparknlp/common/match_strategy.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/properties.py` & `spark-nlp-4.4.4/sparknlp/common/properties.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/read_as.py` & `spark-nlp-4.4.4/sparknlp/common/read_as.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/recursive_annotator_approach.py` & `spark-nlp-4.4.4/sparknlp/common/recursive_annotator_approach.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/storage.py` & `spark-nlp-4.4.4/sparknlp/common/storage.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/common/utils.py` & `spark-nlp-4.4.4/sparknlp/common/utils.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/functions.py` & `spark-nlp-4.4.4/sparknlp/functions.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/internal/__init__.py` & `spark-nlp-4.4.4/sparknlp/internal/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/internal/annotator_java_ml.py` & `spark-nlp-4.4.4/sparknlp/internal/annotator_java_ml.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/internal/annotator_transformer.py` & `spark-nlp-4.4.4/sparknlp/internal/annotator_transformer.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/internal/extended_java_wrapper.py` & `spark-nlp-4.4.4/sparknlp/internal/extended_java_wrapper.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/internal/params_getters_setters.py` & `spark-nlp-4.4.4/sparknlp/internal/params_getters_setters.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/internal/recursive.py` & `spark-nlp-4.4.4/sparknlp/internal/recursive.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/logging/__init__.py` & `spark-nlp-4.4.4/sparknlp/logging/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/logging/comet.py` & `spark-nlp-4.4.4/sparknlp/logging/comet.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/pretrained/__init__.py` & `spark-nlp-4.4.4/sparknlp/pretrained/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/pretrained/pretrained_pipeline.py` & `spark-nlp-4.4.4/sparknlp/pretrained/pretrained_pipeline.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/pretrained/resource_downloader.py` & `spark-nlp-4.4.4/sparknlp/pretrained/resource_downloader.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/pretrained/utils.py` & `spark-nlp-4.4.4/sparknlp/pretrained/utils.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/__init__.py` & `spark-nlp-4.4.4/sparknlp/training/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/graph_builders.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/graph_builders.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/ner_dl/create_graph.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/ner_dl/create_graph.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/ner_dl/dataset_encoder.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/ner_dl/dataset_encoder.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/ner_dl/ner_model.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/ner_dl/ner_model.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/ner_dl/ner_model_saver.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/ner_dl/ner_model_saver.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/ner_dl/sentence_grouper.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/ner_dl/sentence_grouper.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/tf2contrib/__init__.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/tf2contrib/__init__.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/tf2contrib/core_rnn_cell.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/tf2contrib/core_rnn_cell.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/tf2contrib/fused_rnn_cell.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/tf2contrib/fused_rnn_cell.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/tf2contrib/gru_ops.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/tf2contrib/gru_ops.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/tf2contrib/lstm_ops.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/tf2contrib/lstm_ops.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/tf2contrib/rnn.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/tf2contrib/rnn.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders/tf2contrib/rnn_cell.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders/tf2contrib/rnn_cell.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders_1x/graph_builders.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders_1x/graph_builders.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders_1x/ner_dl/create_graph.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders_1x/ner_dl/create_graph.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders_1x/ner_dl/dataset_encoder.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders_1x/ner_dl/dataset_encoder.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders_1x/ner_dl/ner_model.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders_1x/ner_dl/ner_model.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders_1x/ner_dl/ner_model_saver.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders_1x/ner_dl/ner_model_saver.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/_tf_graph_builders_1x/ner_dl/sentence_grouper.py` & `spark-nlp-4.4.4/sparknlp/training/_tf_graph_builders_1x/ner_dl/sentence_grouper.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/conll.py` & `spark-nlp-4.4.4/sparknlp/training/conll.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/conllu.py` & `spark-nlp-4.4.4/sparknlp/training/conllu.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/pos.py` & `spark-nlp-4.4.4/sparknlp/training/pos.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/pub_tator.py` & `spark-nlp-4.4.4/sparknlp/training/pub_tator.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/training/spacy_to_annotation.py` & `spark-nlp-4.4.4/sparknlp/training/spacy_to_annotation.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/upload_to_hub.py` & `spark-nlp-4.4.4/sparknlp/upload_to_hub.py`

 * *Files identical despite different names*

### Comparing `spark-nlp-4.4.3/sparknlp/util.py` & `spark-nlp-4.4.4/sparknlp/util.py`
