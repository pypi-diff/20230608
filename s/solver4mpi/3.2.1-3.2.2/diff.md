# Comparing `tmp/solver4mpi-3.2.1.tar.gz` & `tmp/solver4mpi-3.2.2.tar.gz`
...
+gzip compressed data, was "solver4mpi-3.2.2.tar", last modified: Thu Jun  8 15:35:33 2023, max compression
```

## Comparing `solver4mpi-3.2.1.tar` & `solver4mpi-3.2.2.tar`
...
+drwxr-xr-x   0 mregnier   (501) staff       (20)        0 2023-06-08 15:35:33.205363 solver4mpi-3.2.2/
+-rw-r--r--   0 mregnier   (501) staff       (20)      231 2023-06-08 15:35:33.205214 solver4mpi-3.2.2/PKG-INFO
+-rw-r--r--   0 mregnier   (501) staff       (20)       21 2023-06-08 10:41:05.000000 solver4mpi-3.2.2/README.md
+-rw-r--r--   0 mregnier   (501) staff       (20)       38 2023-06-08 15:35:33.205409 solver4mpi-3.2.2/setup.cfg
+-rw-r--r--   0 mregnier   (501) staff       (20)      740 2023-06-08 15:35:03.000000 solver4mpi-3.2.2/setup.py
+drwxr-xr-x   0 mregnier   (501) staff       (20)        0 2023-06-08 15:35:33.201968 solver4mpi-3.2.2/solver4mpi/
+-rw-r--r--   0 mregnier   (501) staff       (20)       47 2023-06-08 10:41:05.000000 solver4mpi-3.2.2/solver4mpi/__init__.py
+-rw-r--r--   0 mregnier   (501) staff       (20)     4423 2023-06-08 15:34:31.000000 solver4mpi-3.2.2/solver4mpi/minimizer_multiprocess.py
+-rw-r--r--   0 mregnier   (501) staff       (20)     2133 2023-06-08 13:14:23.000000 solver4mpi-3.2.2/solver4mpi/test.py
+drwxr-xr-x   0 mregnier   (501) staff       (20)        0 2023-06-08 15:35:33.205024 solver4mpi-3.2.2/solver4mpi.egg-info/
+-rw-r--r--   0 mregnier   (501) staff       (20)      231 2023-06-08 15:35:33.000000 solver4mpi-3.2.2/solver4mpi.egg-info/PKG-INFO
+-rw-r--r--   0 mregnier   (501) staff       (20)      266 2023-06-08 15:35:33.000000 solver4mpi-3.2.2/solver4mpi.egg-info/SOURCES.txt
+-rw-r--r--   0 mregnier   (501) staff       (20)        1 2023-06-08 15:35:33.000000 solver4mpi-3.2.2/solver4mpi.egg-info/dependency_links.txt
+-rw-r--r--   0 mregnier   (501) staff       (20)       24 2023-06-08 15:35:33.000000 solver4mpi-3.2.2/solver4mpi.egg-info/requires.txt
+-rw-r--r--   0 mregnier   (501) staff       (20)       11 2023-06-08 15:35:33.000000 solver4mpi-3.2.2/solver4mpi.egg-info/top_level.txt
```

### Comparing `solver4mpi-3.2.1/setup.py` & `solver4mpi-3.2.2/setup.py`
...
### Comparing `solver4mpi-3.2.1/solver4mpi/minimizer_multiprocess.py` & `solver4mpi-3.2.2/solver4mpi/minimizer_multiprocess.py`
...
### Comparing `solver4mpi-3.2.1/solver4mpi/test.py` & `solver4mpi-3.2.2/solver4mpi/test.py`
