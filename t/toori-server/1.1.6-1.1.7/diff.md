# Comparing `tmp/toori-server-1.1.6.tar.gz` & `tmp/toori-server-1.1.7.tar.gz`
...
## Comparing `toori-server-1.1.6.tar` & `toori-server-1.1.7.tar`
...
### Comparing `toori-server-1.1.6/PKG-INFO` & `toori-server-1.1.7/PKG-INFO`
...
### Comparing `toori-server-1.1.6/README.md` & `toori-server-1.1.7/README.md`

 * *Files identical despite different names*

### Comparing `toori-server-1.1.6/iro/main.py` & `toori-server-1.1.7/iro/main.py`
...
### Comparing `toori-server-1.1.6/setup.py` & `toori-server-1.1.7/setup.py`
...
### Comparing `toori-server-1.1.6/toori_server.egg-info/PKG-INFO` & `toori-server-1.1.7/toori_server.egg-info/PKG-INFO`
