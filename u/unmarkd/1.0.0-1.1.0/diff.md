# Comparing `tmp/unmarkd-1.0.0.tar.gz` & `tmp/unmarkd-1.1.0.tar.gz`
...
## Comparing `unmarkd-1.0.0.tar` & `unmarkd-1.1.0.tar`
...
### Comparing `unmarkd-1.0.0/LICENSE.md` & `unmarkd-1.1.0/LICENSE.md`

 * *Files identical despite different names*

### Comparing `unmarkd-1.0.0/README.md` & `unmarkd-1.1.0/README.md`
...
### Comparing `unmarkd-1.0.0/pyproject.toml` & `unmarkd-1.1.0/pyproject.toml`
...
### Comparing `unmarkd-1.0.0/unmarkd/unmarkers.py` & `unmarkd-1.1.0/unmarkd/unmarkers.py`
...
### Comparing `unmarkd-1.0.0/PKG-INFO` & `unmarkd-1.1.0/PKG-INFO`
