# Comparing `tmp/watchmen_inquiry_surface-16.5.7.tar.gz` & `tmp/watchmen_inquiry_surface-16.5.8.tar.gz`
...
## Comparing `watchmen_inquiry_surface-16.5.7.tar` & `watchmen_inquiry_surface-16.5.8.tar`
...
### Comparing `watchmen_inquiry_surface-16.5.7/LICENSE` & `watchmen_inquiry_surface-16.5.8/LICENSE`

 * *Files identical despite different names*

### Comparing `watchmen_inquiry_surface-16.5.7/pyproject.toml` & `watchmen_inquiry_surface-16.5.8/pyproject.toml`
...
### Comparing `watchmen_inquiry_surface-16.5.7/src/watchmen_inquiry_surface/data/data_router.py` & `watchmen_inquiry_surface-16.5.8/src/watchmen_inquiry_surface/data/data_router.py`

 * *Files identical despite different names*

### Comparing `watchmen_inquiry_surface-16.5.7/PKG-INFO` & `watchmen_inquiry_surface-16.5.8/PKG-INFO`
